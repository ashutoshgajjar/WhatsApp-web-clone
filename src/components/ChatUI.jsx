  ...
  return (
    <>
      <section className='flex-1 dark:bg-zinc-900 dark:text-white flex flex-col'>
        <header className='flex items-center justify-between p-2 border-b border-black/10 dark:border-white/10 bg-white dark:bg-zinc-900'>
          <button className='inline-flex items-center gap-3 cursor-pointer hover:bg-gray-100 dark:hover:bg-zinc-700 p-2 rounded-lg transition-colors'>
            <div className='w-10 h-10 rounded-full bg-emerald-500 text-white flex items-center justify-center font-semibold text-sm'>
        ...
        <main className='flex-1 overflow-hidden'>
          <div
            className='relative z-1 bg-cover bg-center h-full'
          ...
          >
            ...
            <div
              key={activeChat?.waId}
              id='msgContainer'
              className='relative flex flex-col z-10 py-4 px-2 space-y-4 overflow-y-auto h-[calc(100dvh-9.5rem)]'
              ...
              {currentMessages.length === 0 ? (
                ...
                currentMessages.map((message, idx) => {
                  ...
                  return (
                    ...
                    >
                      {isOutbound && (
                        <div className='relative rounded-b-lg rounded-tl-lg shadow-md border border-green-300 dark:border-green-950 w-fit p-2 dark:bg-green-900 bg-green-200 max-w-64 md:max-w-xs lg:max-w-lg'>
                      ...
                      {isInbound && (
                        <div className='relative inline-block w-fit h-auto bg-zinc-50 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-900 rounded-tr-lg rounded-b-lg max-w-64 md:max-w-xs lg:max-w-lg'>
            ...
            <div className='relative z-10 p-2'>
              <form onSubmit={sendMessage} className='flex items-center'>
                <div className='flex items-center bg-white dark:bg-zinc-800/50 bg-transparent backdrop-blur-xl w-full p-2 rounded-full border border-black/10 dark:border-white/5'>
                  <button
                    type='button'
                    className='inline-flex p-2 rounded-full text-black/75 dark:text-white/75 hover:bg-stone-100 dark:hover:bg-neutral-700'
                  >
                  ...
                  <input
                    ...
                    disabled={isSending}
                    className='flex-1 p-1.5 focus:outline-none bg-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400'
                  />
                  <button
                    type='submit'
                  ...
                  >
                    {isSending ? (
                      ...
                      <RiSendPlane2Line className='size-5 fill-current' />
                    )}
                  </button>
                </div>
              </form>
