...
function SettingsPage() {
  return (
    <>
      <section className='sm:w-80 md:w-88 lg:w-100 flex-1 px- py-2 bg-white dark:bg-zinc-900 dark:text-white border-x border-black/10 dark:border-white/10'>
        ...
        <div className='h-[calc(100vh-6.35rem)] px-3 overflow-y-auto'>
          <div className='py-3'>
            <div className='flex items-center relative gap-2 p-3 cursor-pointer group hover:bg-neutral-100 dark:hover:bg-zinc-700 rounded-xl'>
              <img
          ...
          <div className='space-y-1'>
            <button className='inline-flex items-center gap-5 w-full rounded-md p-4 text-left transition-all duration-50 text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700'>
            ...
            <button className='inline-flex items-center gap-5 w-full rounded-md p-4 text-left transition-all duration-50 text-red-700 dark:text-red-500 hover:bg-red-100 dark:hover:bg-red-900/25'>
